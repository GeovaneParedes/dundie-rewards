import pytest
from dundie.database import connect, add_person, authenticate_user
...
def test_authenticate_user():
    ...
    # Em add_person, a senha aleatória criada é salva com hash
...
def test_authenticate_user_function():
    ...
    assert authenticate_user(db, "nonexistent@dundler.com", "mysecret") is False
