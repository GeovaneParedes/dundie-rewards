...
def test_positive_check_valid_email(address):
    ...
    assert check_valid_email(address)


@pytest.mark.unit
@pytest.mark.parametrize("address", ["bruno@.com", "joedoe.com", "a@b."])
...
@pytest.mark.unit
def test_generation_simple_password():
    """Test generation of random simple passwords.
    TODO: Generate hashed complex passwords. encrypit is
    """
    passwords = []
    for _ in range(100):
