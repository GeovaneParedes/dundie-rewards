...
```csv
Jim Halpert, Sales, Saleman, jim@dundlermifflin.com
Dwight Schrute, Sales, Manager, schrute@dundlermifflin.com
Gabe Lewis, C-Level, CEO, glewis@dundlermifflin.com
```
...
> **NOTE** passing `--output=file.json` will save a json file with results.
